...
export default function ModelEarth() {
  ...
  useEffect(() => {
    ...
    // ── 3. Earth Group (Real 23.4° axial tilt) ─────────────────
    ...
    // Normal, clean Standard PBR Material
    ...
    // Space ambient light (deep soft blue so dark side is natural, not completely pitch black)
    const ambientLight = new THREE.AmbientLight(0x0e1726, 0.75);
    scene.add(ambientLight);

    // Subtle atmospheric backlight rim
